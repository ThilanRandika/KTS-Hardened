...
function MiddleD() {
  return (
    <div
      className="w-full h-full  bg-contain pl-8 pr-9 flex justify-center items-center rounded-[10px] "
      style={{
        backgroundImage:
    ...
    >
      <div className="flex xsm:gap-10 gap-4 xsm:flex-row flex-col">
        <div className="bg-main_blue w-full xsm:h-[90px] h-[70px] rounded-3xl flex flex-col xsm:px-7 px-[40px] py-4 justify-center gap-1">
